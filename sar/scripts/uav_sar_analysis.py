...
def main():
    ...
    parser = argparse.ArgumentParser(description="Analyze the ROS bag files of the search and rescue in terms of area covered over time.", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
